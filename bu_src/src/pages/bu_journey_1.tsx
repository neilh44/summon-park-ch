  ...
  return (
    <div className="flex h-screen flex-col bg-white">
      ...
      <main className="flex flex-1 overflow-hidden relative">
        ...
        {/* Media Section */}
        <div className={`absolute sm:relative w-64 border-l bg-white h-full transition-transform duration-300 ${
            ...
            <div className="flex-1 overflow-auto space-y-4">
              {responseData?.sql_query ? (
                <div className="bg-gray-50 p-3 rounded-md">
                  <h3 className="font-semibold text-sm mb-2">SQL Query</h3>
              ...
              {responseData?.query_results ? (
                <div className="bg-gray-50 p-3 rounded-md">
                  <h3 className="font-semibold text-sm mb-2">Query Results</h3>
                  <pre className="text-xs text-gray-700 whitespace-pre-wrap">
                    {JSON.stringify(responseData.query_results, null, 2)}
                  </pre>
                </div>
              ) : null}

              {!responseData?.sql_query && !responseData?.query_results && (
