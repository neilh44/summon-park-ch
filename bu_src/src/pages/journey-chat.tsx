                  ...
                  <div className="mt-4">
                    {message.responseData.query_results.length === 1 ? (
                      ...
                      <DataVisualization
                        ...
                        labels={message.responseData.sql_query ? 
                          message.responseData.sql_query.split('SELECT')[1].split('FROM')[0].trim().split(',').map(col => col.trim()) 
                          : undefined
                        } 
                      />
                    )}
                    {message.responseData.sql_query && (
